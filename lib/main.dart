...
import 'package:sweetyboutique_app/middleware/appMiddleWare.dart';
...
import 'package:sweetyboutique_app/middleware/appMiddleWare.dart';
import 'package:sweetyboutique_app/reducer/login/appReducer.dart';
...
void main() async {
  ...
  // Load initial state
  final initialState = await persistor.load(); //wait
 ...
 class MyApp extends StatefulWidget {
  final Store<AppState>? store1;
  MyApp({super.key, required this.store1});
  @override
